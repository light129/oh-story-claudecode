...
| 目录 | 内容 |
|---|---|
| [`长篇/…/正文/第021章_离别开出花.md`](长篇/让你管账号，你高燃混剪炸全网/正文/第021章_离别开出花.md) | `/story-long-write` 续写的第 21 章（2204 字，四道检查全过） |
| [`长篇/…/大纲/细纲_第021章.md`](长篇/让你管账号，你高燃混剪炸全网/大纲/细纲_第021章.md) | 对应细纲，`check-outline-contract.js` 9/9 通过 |
| [`长篇/…/.deslop-whitelist`](长篇/让你管账号，你高燃混剪炸全网/.deslop-whitelist) · [`追踪/逐章记录/第021章.md`](长篇/让你管账号，你高燃混剪炸全网/追踪/逐章记录/第021章.md) | 书级风格白名单；第 21 章追踪事务的逐章记录（含「本章退役登记」） |
| [`去AI味对照/`](去AI味对照/README.md) | `/story-deslop` 检查器的真实扫描输出：AI 腔样例 9 处命中 vs 干净写法零命中 |

> `追踪/` 已通过 `storyctl.py chapter commit` 正式推进到第 21 章（`state_revision` 0 → 1），派生视图全部由
> `_tracking-state.json` 重生成；`.deslop-whitelist` 登记了本书既定的「……」与章末分隔线，仅豁免风格检查。